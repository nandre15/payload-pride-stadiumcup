  ...
  days: ScheduleDay[] = [
    {
      ...
      events: [
        ...
        { time: '8:15 PM ET', label: 'Playoffs', note: 'Group A #1 vs Group B #2 (1 Standard Competitive Stadium Match)' },
        { time: '8:15 PM ET', label: 'Playoffs', note: 'Group B #1 vs Group A #2 (1 Standard Competitive Stadium Match)' },
