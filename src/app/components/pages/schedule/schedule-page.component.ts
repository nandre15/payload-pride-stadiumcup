  ...
  days: ScheduleDay[] = [
    {
      ...
      events: [
        { time: '11:00 AM ET', label: 'Team Check-In', note: 'Discord check-in required for all teams' },
        { time: '12:00 PM ET', label: 'Round 1', note: 'Group A: Team A vs Team B (1 Standard Quickplay Stadium Match)' },
        { time: '12:00 PM ET', label: 'Round 1', note: 'Group B: Team D vs Team E (1 Standard Quickplay Stadium Match)' },
        { time: '1:00 PM ET', label: 'Round 2', note: 'Group A: Team B vs Team C (1 Standard Quickplay Stadium Match)' },
        { time: '1:00 PM ET', label: 'Round 2', note: 'Group B: Team E vs Team F (1 Standard Quickplay Stadium Match)' },
        { time: '2:00 PM ET', label: 'Round 3', note: 'Group A: Team A vs Team C (1 Standard Quickplay Stadium Match)' },
        { time: '2:00 PM ET', label: 'Round 3', note: 'Group B: Team D vs Team F (1 Standard Quickplay Stadium Match)' },
        { time: '3:00 PM ET', label: 'Playoffs', note: 'Group A #1 vs Group B #2 (1 Standard Competitive Stadium Match)' },
        { time: '3:00 PM ET', label: 'Playoffs', note: 'Group B #1 vs Group A #2 (1 Standard Competitive Stadium Match)' },
        { time: '4:30 PM ET', label: 'Grand Final', note: 'Winner SF1 vs Winner SF2 (Best of 3 Stadium Quickplay Matches)' },
      ],
    },
  ];
