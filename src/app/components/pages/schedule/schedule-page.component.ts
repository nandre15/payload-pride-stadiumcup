  ...
  days: ScheduleDay[] = [
    {
      ...
      events: [
        { time: '10:00 AM ET', label: 'Check-in Opens', note: 'Discord check-in required for all teams' },
        { time: '11:00 AM ET', label: 'Check-in Closes', note: 'Teams not checked in will be replaced by waitlist' },
        { time: '11:30 AM ET', label: 'Opening Ceremony', note: 'Welcome stream + sponsor shoutouts on Twitch' },
        { time: '12:00 PM ET', label: 'Group Stage Begins', note: 'All groups play simultaneously — check your bracket' },
        { time: '4:00 PM ET',  label: 'Group Stage Ends', note: 'Estimated end time — may vary based on match pace' },
        { time: '4:30 PM ET',  label: 'Quarterfinal Seeding Announced', note: 'Posted in Discord and on stream' },
        { time: '5:00 PM ET',  label: 'Quarterfinals Begin', note: 'Best of 3 — top 8 teams advance' },
        { time: '8:00 PM ET',  label: 'Day 1 Wrap', note: 'Semifinalists confirmed — post-day stream recap' },
      ],
    },
    {
      date: 'Sunday, June 22',
      label: 'Day 2 — Finals Day',
      color: PRIDE_COLORS[0],
      events: [
        { time: '11:00 AM ET', label: 'Pre-Show Begins', note: 'Community highlights, interviews, and hype on stream' },
        { time: '12:00 PM ET', label: 'Semifinals — Match 1', note: 'Best of 5 — streamed live' },
        { time: '2:00 PM ET',  label: 'Semifinals — Match 2', note: 'Best of 5 — streamed live' },
        { time: '3:30 PM ET',  label: 'Break + Third Place Match', note: 'Estimated — timing depends on semifinal length' },
        { time: '5:00 PM ET',  label: 'Grand Finals', note: 'Best of 5 — fully produced stream with commentary' },
        { time: '7:00 PM ET',  label: 'Awards Ceremony', note: 'Prize distribution, MVP awards, and closing celebration' },
        { time: '7:30 PM ET',  label: 'Community Afterparty', note: 'Open Discord VC — everyone welcome, no ticket required' },
      ],
    },
  ];
